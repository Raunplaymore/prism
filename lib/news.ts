...
Each item: {"originalIndex":number,"category":"one of the categories below","title":"${langLabel} title","summary":"1-2 sentence ${langLabel} summary","detail":"3 paragraphs in ${langLabel} separated by \\n\\n. Each paragraph is 2-3 connected sentences with natural flow. Paragraph 1: background and historical context. Paragraph 2: stakeholders involved and why this matters now. Paragraph 3: downstream implications and what to watch.","sentiment":"positive"|"neutral"|"negative","keywords":["slug1","slug2",...]}
Write title, summary, and detail in ${langLabel}. "summary" is a brief overview. "detail" is structured as 3 paragraphs separated by \n\n: (1) background and historical context, (2) stakeholders involved and why this matters now, (3) downstream implications and what to watch. Each paragraph is 2-3 connected sentences with natural flow — use connectors and transitions, do not write one-sentence paragraphs. Do not output paragraph numbers or labels. Do not use markdown bullets or headings. "detail" MUST introduce information that is not in "summary". Restating the summary in different words is forbidden.
