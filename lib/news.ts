...
Each item: {"originalIndex":number,"category":"one of the categories below","title":"${langLabel} title","summary":"1-2 sentence ${langLabel} summary","detail":"2-4 sentence ${langLabel} natural-flow summary of what's actually in the source article. Use only information present in the input description; do not invent context, implications, or speculation.","sentiment":"positive"|"neutral"|"negative","keywords":["slug1","slug2",...]}
Write title, summary, and detail in ${langLabel}. "summary" is a brief 1-2 sentence overview. "detail" is a natural-flow 2-4 sentence elaboration that ONLY uses information actually present in the input description. CRITICAL: Do not add historical context, implications, predictions, "what to watch" remarks, or stakeholder analysis unless that information is explicitly stated in the source. If the input is short and you have nothing additional to say, keep "detail" short — a single sentence is fine. It is far better to write a short faithful detail than a long invented one.
