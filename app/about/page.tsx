...
export const metadata: Metadata = {
  title: 'About — Prism Globe',
  description: `Prism Globe은 AI 기반 세계 뉴스 브리핑 서비스입니다. ${SUPPORTED_COUNT}개국의 뉴스를 한국어로 요약하여 제공합니다.`,
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12">
        <h1 className="mb-2 text-3xl font-bold">About Prism Globe</h1>
        <p className="mb-10 text-sm text-gray-400">
          AI가 정제한 세계 뉴스 — Prism Globe / refracted by AI
        </p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3 text-sm leading-relaxed text-gray-300">
            Prism Globe은 단순한 기사 모음이 아닙니다. 각 기사에 대해 다음 단계의 처리를 거쳐 독자적인 한국어 브리핑을 만듭니다.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3 text-sm leading-relaxed text-gray-300">
            Prism Globe은 운영 비용 일부를 Google AdSense를 통한 광고로 충당합니다. 다음 원칙을 지킵니다.
          </p>
          <ul className="space-y-2 text-sm text-gray-300">
        ...
        <div className="mt-12 text-center">
          <a href="/" className="text-sm text-blue-400 hover:text-blue-300">← Back to Prism Globe</a>
        </div>
      </div>
    </div>
  )
