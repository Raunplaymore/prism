...
export const metadata: Metadata = {
  title: '키워드로 보는 세계 뉴스 — Prism Globe',
  description:
    'Prism Globe이 50여 개국에서 수집한 기사를 인물·국가·조직·기업·토픽·이벤트로 인덱싱한 키워드 클라우드. 같은 주제를 여러 국가가 어떻게 다루는지 비교해보세요.',
  alternates: { canonical: '/keyword' },
  robots: { index: true, follow: true },
  openGraph: {
    title: '키워드로 보는 세계 뉴스 — Prism Globe',
    description:
      'Prism Globe이 50여 개국에서 수집한 기사를 정규화된 키워드로 인덱싱. 같은 주제를 여러 국가가 어떻게 다루는지 비교.',
    type: 'website',
    locale: 'ko_KR',
    images: ['/og-image.png'],
  },
        ...
        <div className="mb-8">
          ...
          <details className="group mt-2 max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-relaxed text-gray-300">
              Prism Globe은 매일 50여 개국의 현지 언론에서 수집한 기사를 AI가 분류·요약하고,
