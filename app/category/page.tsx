  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="mx-auto max-w-3xl p-4 sm:p-8">
        ...
        <div className="relative isolate mb-3 flex h-[190px] items-center justify-center overflow-hidden rounded-2xl border border-gray-900 bg-gradient-to-b from-gray-950 to-gray-900/40 text-sm font-semibold sm:h-[350px] sm:text-lg lg:h-[400px] lg:text-xl">
