...
export const metadata: Metadata = {
  title: 'Privacy Policy — Prism Globe',
  description: 'Prism Globe 개인정보 처리방침',
      ...
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 text-sm leading-relaxed text-gray-300">
            Prism Globe은 서비스 제공을 위해 최소한의 정보만 수집합니다.
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-gray-300">
            Prism Globe은 로그인 세션 유지를 위해 HttpOnly 쿠키를 사용합니다. 이 쿠키는 7일 후 자동 만료됩니다.
            로그아웃 시 즉시 삭제됩니다.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-sm leading-relaxed text-gray-300">
            Prism Globe은 Google AdSense를 통해 광고를 게재할 수 있습니다. Google AdSense는 사용자의 관심사에 기반한
